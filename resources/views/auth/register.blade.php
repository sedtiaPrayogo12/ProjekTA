...
<body class="min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="role" class="block text-gray-700 text-sm font-bold mb-2 ml-3" value="{{ __('Role') }}" />
                <select name="role" id="role" class="block mt-1 w-full rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-blue-900 transition duration-500 px-3 pb-3">
